...
<body>
    ...
    function fetchtable() {
        ...
        console.log(
            "<?php echo $api_url; ?>get/eng_dealers_users.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>"
        );
        fetch("<?php echo $api_url; ?>get/eng_dealers_users.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
            ...
            .then(response => {
                ...
                $.each(response, function(index, data) {
                    ...
                    table.row.add([
                        ...
                        data.sap_no,
                        data.asm_name,
                        data.asset_verification_status,
