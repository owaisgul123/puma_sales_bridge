...
<body>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom">
            <h5 id="offcanvasRightLabel">Product</h5>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#insert_form').on("submit", function (event) {
                ...
                if (update_id == 0) {
                    ...
                    $.ajax({
                        url: "<?php echo $api_url; ?>create/create_products.php",
                        cache: false,
                        contentType: false,
                        processData: false,
                        method: "POST",
        ...
        function fetchtable() {
            ...
            fetch("<?php echo $api_url; ?>get/get_all_products.php?key=03201232927&id=<?php echo $_SESSION['user_id'] ?>", requestOptions)
