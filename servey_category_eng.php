        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3>Survey Category Engineering</h3>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#insert_form').on("submit", function (event) {
                ...
                $.ajax({
                    url: "<?php echo $api_url; ?>create/create_survey_category_eng.php",
                    cache: false,
                    contentType: false,
                    processData: false,
                    method: "POST",
        ...
        function fetchtable() {
            ...
            fetch("<?php echo $api_url; ?>get/get_survey_category_eng.php?key=03201232927&id=<?php echo $_SESSION['user_id'] ?>", requestOptions)
