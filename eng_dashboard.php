...
<body>
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="inputEmail4">Eng-Users</label>
                                ...
                                <div class="card-body">
                                    <div>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="mb-0 font-size-15">Eng-Users</h6>
                                            </div>
                            ...
                            <table id="myTable" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Eng-User</th>
    ...
    function fetchtable() {
        ...
        console.log(
            "<?php echo $api_url; ?>get/eng/eng_users_dealers.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>"
        );
        fetch("<?php echo $api_url; ?>get/eng/eng_users_dealers.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
        ...
        console.log(
            "<?php echo $api_url; ?>get/eng/all_dealers_inspection.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>&from=" +
            fromdate + "&to=" + todate + "")
        fetch("<?php echo $api_url; ?>get/eng/all_dealers_inspection.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>&from=" +
                fromdate + "&to=" + todate + "",
                requestOptions)
            .then(response => response.json())
            .then(response => {
                ...
                $.each(response, function(index, data) {
                    ...
                    task_table.row.add([
                        index + 1,
                        '<a href="inspection_report_eng.php?name=' + data.user_name +
        ...
        console.log(
            "<?php echo $api_url; ?>get/eng/get_all_specific_visits_user.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>&from=" +
            fromdate + "&to=" + todate + "")
        fetch("<?php echo $api_url; ?>get/eng/get_all_specific_visits_user.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>&from=" +
                fromdate + "&to=" + todate + "",
                requestOptions)
            .then(response => response.json())
            .then(response => {
        ...
        console.log('<?php echo $api_url; ?>get/eng/get_region_district_dealers.php?key=03201232927')
        $.ajax({
            url: '<?php echo $api_url; ?>/get/eng/get_region_district_dealers.php?key=03201232927',
            method: 'GET',
            dataType: 'json',
            success: function(data) {
                console.log(data);
    ...
    function filterTable() {
        ...
        var filteredData = dealers_data.filter(function(item) {
            ...
            return (
                ...
                (tm_counts.length === 0 || tm_counts.includes(item.eng_user_id))
            );
        });
