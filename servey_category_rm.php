    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#insert_form').on("submit", function (event) {
                ...
                $.ajax({
                    url: "<?php echo $api_url; ?>create/create_survey_category_rm.php",
                    cache: false,
                    contentType: false,
                    processData: false,
                    method: "POST",
        ...
        function fetchtable() {
            ...
            fetch("<?php echo $api_url; ?>get/get_survey_category_rm.php?key=03201232927&id=<?php echo $_SESSION['user_id'] ?>", requestOptions)
        ...
        function check(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo $api_url; ?>update/survey_cat_update_rm.php', // Replace with the path to your PHP script
                data: {
