...
<body>
    ...
    $(document).ready(function() {
        ...
        $('#insert_form').on("submit", function(event) {
            ...
            $.ajax({
                url: "<?php echo $api_url; ?>create/eng/create_dealers_inspection_task.php",
                cache: false,
                contentType: false,
                processData: false,
                method: "POST",
    ...
    function all_dealers() {
        ...
        fetch("<?php echo $api_url; ?>get/get_eng_users.php?key=03201232927", requestOptions)
    ...
    function get_managers(id) {
        ...
        if (id != "") {
            ...
            console.log("<?php echo $api_url; ?>get/eng/get_current_month_visit_dealers.php?key=03201232927&id=" + id + "&pre=" +
                dataIdValue + "");
            fetch("<?php echo $api_url; ?>get/eng/get_current_month_visit_dealers.php?key=03201232927&id=" + id + "&pre=" +
                    dataIdValue + "",
                    requestOptions)
                .then(response => response.json())
                .then(response => {
    ...
    function fetchtable() {
        ...
        console.log(
            "<?php echo $api_url; ?>get/eng/get_task_inspection.php?key=03201232927&user_id=<?php echo $_SESSION['user_id'] ?>&pre=<?php echo $_SESSION['privilege'] ?>&from=" +fromdate + "&to=" + todate + ""
        )
        fetch("<?php echo $api_url; ?>get/eng/get_task_inspection.php?key=03201232927&user_id=<?php echo $_SESSION['user_id'] ?>&pre=<?php echo $_SESSION['privilege'] ?>&from=" +fromdate + "&to=" + todate + "",
                requestOptions)
            .then(response => response.json())
            .then(response => {
                console.log(response)
