...
<body>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom">
            <h5 id="offcanvasRightLabel">Object Part</h5>
                ...
                <form method="post" id="insert_form" enctype="multipart/form-data">
                    ...
                    <div class="form-row mb-4">
                        <div class="form-group col-md-12">
                            <label for="inputEmail4">Part</label>
    ...
    $(document).ready(function() {
        ...
        $('#insert_form').on("submit", function(event) {
            ...
            if (update_id == 0) {
                ...
                $.ajax({
                    url: "<?php echo $api_url; ?>create/create_object_part.php",
                    cache: false,
                    contentType: false,
                    processData: false,
                    method: "POST",
    ...
    function fetchtable() {
        ...
        fetch("<?php echo $api_url; ?>get/get_object_part.php?key=03201232927&id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
